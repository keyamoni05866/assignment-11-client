...
const ExtraSection1 = () => {
  ...
  <div className="card-body text-center mt-0">
    ...
    <div className="card-actions justify-end">
      <button className="btn bg-purple-600 btn-block ">Add to Cart</button>
    </div>
  </div>
</div>
<div className="card w-96 bg-base-100 shadow-xl">
  ...
  <div className="card-body text-center mt-0">
    <h2 className=" text-center text-lg ">Specials</h2>
    <p className="text-xl ">Toy-Name:Ride Horse</p>
...
<div className="card w-96 bg-base-100 shadow-xl">
  ...
  <div className="card-body text-center mt-0">
    <h2 className=" text-center text-lg ">Specials</h2>
    <p className="text-xl ">Toy-Name:Mouse</p>
    <p className="mb-4">Price:$10</p>
    <div className="card-actions justify-end">
      <button className="btn bg-purple-600 btn-block ">Add to Cart</button>
    </div>
  </div>
...
<div className="card w-96 bg-base-100 shadow-xl">
  ...
  <div className="card-body text-center mt-0">
    <h2 className=" text-center text-lg ">Specials</h2>
    <p className="text-xl ">Toy-Name:Teddy</p>
...
<div className="card w-96 bg-base-100 shadow-xl">
  ...
  <div className="card-body text-center mt-0">
    <h2 className=" text-center text-lg ">Specials</h2>
    <p className="text-xl ">Toy-Name:Lion</p>
    <p className="mb-4">Price:$23</p>
    <div className="card-actions justify-end">
      <button className="btn bg-purple-600 btn-block ">Add to Cart</button>
    </div>
  </div>
...
<div className="card w-96 bg-base-100 shadow-xl">
  ...
  <div className="card-body text-center mt-0">
    <h2 className=" text-center text-lg ">Specials</h2>
    <p className="text-xl ">Toy-Name:Tiger</p>
    <p className="mb-4">Price:$33</p>
    <div className="card-actions justify-end">
      <button className="btn bg-purple-600 btn-block ">Add to Cart</button>
    </div>
  </div>
